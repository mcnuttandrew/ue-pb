...
<div>
    ...
    <p id="chart-option">
        <button name = "mode"  id="rank" class="mode" onclick = "switchDragMode(this)" value = "rank">Rank</button>
        <span id ="separator">|</span> 
        <button name = "mode" id="allocate" class="mode" onclick = "switchDragMode(this)" value = "allocate">Allocate</button>
    </p>
